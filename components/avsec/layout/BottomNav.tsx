...
import type { UserRole } from "@/lib/avsec/reference-data";
...
function navFor(role: UserRole): { left: NavItem[]; right: NavItem[]; fab: { href: string; label: string } } {
  ...
  if (role === "ASO") {
    return {
      left: [
        { href: "/avsec/home", label: "HOME", round: "2px", rot: "0deg" },
        { href: "/avsec/duty", label: "DUTY", round: "50%", rot: "45deg" },
      ],
      right: [
        { href: "/avsec/bay-board", label: "BAY BOARD", round: "2px", rot: "45deg" },
        { href: "/avsec/profile", label: "PROFILE", round: "7px", rot: "0deg" },
      ],
      fab: { href: "/avsec/home", label: "REPORT" },
    };
  }
  ...
  return {
    left: [
      { href: "/avsec/dashboard", label: "DASHBOARD", round: "2px", rot: "0deg" },
      worksAShift
        ? { href: "/avsec/duty", label: "DUTY", round: "50%", rot: "45deg" }
        : { href: "/avsec/history", label: "HISTORY", round: "50%", rot: "0deg", match: ["/avsec/reports/view"] },
    ],
    right: [
      { href: "/avsec/bay-board", label: "BAY BOARD", round: "2px", rot: "45deg" },
      { href: "/avsec/profile", label: "PROFILE", round: "7px", rot: "0deg" },
    ],
    fab: canSubmitDaily ? { href: "/avsec/reports/sec014", label: "REPORT" } : { href: "/avsec/dashboard", label: "REVIEW" },
  };
}
