...
import { getOvertimeRequestById } from "@/lib/duty/overtime-queries";
import { endorseOvertimeRequest, approveOvertimeRequest, rejectOvertimeRequest, withdrawOvertimeRequest } from "@/lib/duty/overtime-actions";
import { createClient } from "@/lib/supabase/server";
import { ROLE_RANK, type UserRole } from "@/lib/reference-data";
...
export default async function OvertimeDetailPage({
  ...
  return (
    <main className="min-h-screen pb-32">
      <AppHeader profile={profile} title="Overtime Request" backHref="/duty/overtime" />
