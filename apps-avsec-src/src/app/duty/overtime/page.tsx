...
import { getVisibleOvertimeRequests } from "@/lib/duty/overtime-queries";
import { createClient } from "@/lib/supabase/server";
import { AppHeader } from "@/components/layout/AppHeader";
import { BottomNav } from "@/components/layout/BottomNav";
import { formatDateMY } from "@/lib/datetime";
...
export default async function OvertimeListPage({
  ...
  return (
    <main className="min-h-screen pb-32">
      <AppHeader profile={profile} title="Overtime" backHref="/duty" />
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-4">
        <Link href="/duty/overtime/new" className="btn-primary w-full block text-center">
          New request
        </Link>
