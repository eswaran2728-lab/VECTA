...
import { getLiveDutyPoints, getHistoryDutyPoints, getRostersForRange, type DutyPoint } from "@/lib/duty/heatmap-queries";
import { getZonesForStation } from "@/lib/duty/zone-queries";
import { getStationTeams, getShifts } from "@/lib/duty/roster-queries";
import { scheduledWindow } from "@/lib/duty/lateness";
import { calcOtHours } from "@/lib/duty/overtime";
import { AppHeader } from "@/components/layout/AppHeader";
import { BottomNav } from "@/components/layout/BottomNav";
import HeatMapLoader from "@/components/duty/HeatMapLoader";
...
export default async function HeatmapPage({
  ...
  return (
    <main className="min-h-screen pb-32">
      <AppHeader profile={profile} title="Duty Heat Map" backHref="/dashboard" />
