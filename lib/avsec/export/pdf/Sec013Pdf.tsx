...
import { REPORT_META, SECURITY_DISCLAIMER, SEC013_CERTIFICATION_TEXT } from "@/lib/avsec/reference-data";
import { formatDateTimeMY } from "@/lib/avsec/datetime";
import type { Sec013Row, Sec013ProfilingDutyEntry } from "@/lib/avsec/types";

export function Sec013Pdf({
  report,
  qrDataUrl,
}: {
  report: Sec013Row & { profiling_duties?: Sec013ProfilingDutyEntry[] };
