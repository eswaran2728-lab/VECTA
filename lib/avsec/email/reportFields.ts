...
import type { Sec016FormValues } from "@/lib/avsec/schemas/sec016";
import type { Sec014FormValues } from "@/lib/avsec/schemas/sec014";
import type { Sec029FormValues } from "@/lib/avsec/schemas/sec029";
import type { Sec018FormValues } from "@/lib/avsec/schemas/sec018";
import type { Sec033FormValues } from "@/lib/avsec/schemas/sec033";
import type { Sec013FormValues } from "@/lib/avsec/schemas/sec013";
import type { OffloadFormValues } from "@/lib/avsec/schemas/offload";
import { SEC029_ITEMS } from "@/lib/avsec/reference-data";
...
export function sec029EmailFields(v: Sec029FormValues): EmailField[] {
  ...
  return [
    ...
    { label: "Aircraft Type", value: v.aircraft_type === "Others" ? v.aircraft_type_other : v.aircraft_type },
    { label: "Flight No", value: v.flight_no },
    { label: "Flight Destination", value: v.flight_destination },
    ...
    ...itemFields,
    { label: "Informed PIC that aircraft security check has been completed", value: v.pic_informed },
