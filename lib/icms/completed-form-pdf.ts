...
import { loadOfficialTemplate, drawValue, drawWrapped, drawSignature, markSelected, markCargoTick } from "@/lib/icms/pdf-overlay";
import type { OfficialFormKind } from "@/lib/icms/pdf-templates";
import { VENDOR_FORM_COORDS } from "@/lib/icms/completed-form-pdf-vendor";
import type {
  CargoType,
  PartA,
  PartBC,
